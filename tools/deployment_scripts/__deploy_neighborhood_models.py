...
models_to_move = [
    ("v23_alpha_gen_neighborhood_2_low_drop_seed_34320", "PROTECTED_LOW_DROP_MASTERPIECE_2026_03_07", "v23_alpha_gen_neighborhood_2_low_drop.json"),
    ("v23_alpha_gen_neighborhood_2_low_drop_seed_44727", "PROTECTED_LOW_DROP_H2_SCALPEL_2026_03_07", "v23_alpha_gen_neighborhood_2_low_drop.json"),
    ("v23_alpha_gen_neighborhood_2_low_drop_seed_48249", "PROTECTED_LOW_DROP_BALANCED_2026_03_07", "v23_alpha_gen_neighborhood_2_low_drop.json")
]

for old_name, new_suffix, config_name in models_to_move:
    # Build new name
    new_base = "v23_alpha_gen_low_drop_" + old_name.split("_seed_")[-1] 

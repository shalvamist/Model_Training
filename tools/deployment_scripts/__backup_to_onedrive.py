...
# Push to Google Drive as requested
gdrive_path = r"G:\My Drive\projects"

# We will create a specific cold-storage backup folder inside GDrive projects
...
with zipfile.ZipFile(zip_filepath, 'w', zipfile.ZIP_DEFLATED) as zipf:
    for root, dirs, files in os.walk(deploy_dir):
        for file in files:
            ...
            # The loose JSONs will go to GitHub. The .pth files go to OneDrive.
